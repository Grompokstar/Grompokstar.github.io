(function ($) {
  ...
  */
  ...
  function Plugin(element, options) {
    ...
    this._src = 'https://boodet-ts.digitalenergy.online/assets/form/form.js'
  ...
  Plugin.prototype.submit = function() {
    ...
    if (_this.modalOpenTime) {
      ...
      if (diff < 1000*10) {
        alert('Извините, но вы похожи на робота!')
        return
      }
    }
  ...
  Plugin.prototype.emailNotification = function() {
    debugger
    $.ajax({
      method: 'post',
      url: 'https://boodet.online/api/notifications/v1/notifications_requests',
      data: {
        notifications_request: {
          key_name: 'feedback_form',
          emails: [
            'danil.tikhomirov@digitalenergy.online',
            'marsel.karamov@digitalenergy.online',
            'info@digitalenergy.online'
          ],
          provided_data: {
